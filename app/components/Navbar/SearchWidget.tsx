  ...
  return (
    <div className='px-5 py-2 rounded-3xl' style={{
      ...
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
            <NavigationMenuTrigger className='rounded-3xl'>United States</NavigationMenuTrigger>
            <NavigationMenuContent>
          ...
          <NavigationMenuItem>
            <NavigationMenuTrigger className='rounded-3xl'>Jun 4 - 6</NavigationMenuTrigger>
            <NavigationMenuContent>
