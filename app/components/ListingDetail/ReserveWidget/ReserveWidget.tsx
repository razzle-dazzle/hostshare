        ...
        <div className="px-6 py-8">
          ...
          <div className="flex mb-6 md:mb-8">
            <div className="flex-1 flex items-center gap-1.5">
              ...
              <span className="text-md text-gray-600 dark:text-white">night</span>
            </div>
            <div className="flex-1 flex items-center justify-end">
              <span className="text-gray-600 dark:text-white text-sm">(65 reviews)</span>
            </div>
          </div>
          ...
          <div className="my-6 md:my-8">
            <p className='text-md font-semibold mb-2'>Check-in / Check-out</p>
